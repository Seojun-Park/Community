...
export default ({
    ...
    let totalDataLength = data.showMarket.length;

    let slicedData = data.showMarket.slice(
    ...
    return (
        <Wrapper>
            <Thead>
                <Title>
                    <Head>Market</Head>
                    <Head><Link to="market/write"><Button text="Write" /></Link></Head>
                </Title>
            </Thead>
